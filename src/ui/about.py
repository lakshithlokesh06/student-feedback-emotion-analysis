...
def render_about() -> None:
    ...
    st.markdown("#### Current status · Phase 4")
    st.write("The application includes validated CSV intake, original and prepared previews, feedback quality summaries, optional context mapping, safe date and rating conversion, and lightweight dataset profiling. Usable feedback can now be classified locally with a pretrained English transformer. The dashboard provides contextual comparisons, rating associations, temporal trends, confidence exploration, shared filters, descriptive insights, and human-review aids. Full and filtered results can be exported as CSV.")
